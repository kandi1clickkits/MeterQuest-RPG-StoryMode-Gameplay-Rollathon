...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/MeterQuest-RPG-StoryMode-Gameplay-Rollathon/releases/download/v1.0.0/MeterQuest-RPG-StoryMode-Gameplay-Rollathon.zip
SET REPO_NAME=MeterQuest-RPG-StoryMode-Gameplay-Rollathon.zip
SET EXTRACTED_REPO_DIR=MeterQuest-RPG-StoryMode-Gameplay-Rollathon
SET NOTEBOOK_NAME=slayers.bat
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
